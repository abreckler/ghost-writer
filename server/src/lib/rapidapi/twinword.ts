...
class TwinwordTopicTaggingApiClient extends RapidApiClient {
  ...
  public async generate(text: string): Promise<TwinwordTopicTaggingGenerateResponse> {
    ...
    return await this._doPostForm<TwinwordTopicTaggingGenerateRequest, TwinwordTopicTaggingGenerateResponse>(
      '/generate/',
      params,
    );
  }
...
export { TwinwordTopicTaggingGenerateRequest, TwinwordTopicTaggingGenerateResponse, TwinwordTopicTaggingApiClient };
